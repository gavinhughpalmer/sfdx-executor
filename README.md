...
sfdx-executor/1.5.4 darwin-x64 node-v15.11.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [lib/commands/executor/run.js](https://github.com/gavinhughpalmer/sfdx-executor/blob/v1.5.4/lib/commands/executor/run.js)_
<!-- commandsstop -->
