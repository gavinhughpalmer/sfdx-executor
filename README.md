...
sfdx-executor/1.1.0 darwin-x64 node-v14.4.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [lib/commands/executor/run.js](https://github.com/gavinhughpalmer/sfdx-executor/blob/v1.1.0/lib/commands/executor/run.js)_
<!-- commandsstop -->
