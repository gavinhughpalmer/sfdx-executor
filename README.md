...
sfdx-executor/1.4.0 darwin-x64 node-v14.13.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [lib/commands/executor/run.js](https://github.com/gavinhughpalmer/sfdx-executor/blob/v1.4.0/lib/commands/executor/run.js)_
<!-- commandsstop -->
